...
export const mapCommercialsData = (data: any): Partial<CommercialsDetails> => {
  ...
  return {
    ...
    sideAccess: features.has('side_access'),
    rearAccess: features.has('rear_access'),
    topAccess: features.has('top_access'),
    gpsTracking: features.has('gps_tracking'),
    fleetManagement: features.has('fleet_management'),
    reverseCamera: features.has('reverse_camera'),
    dashCamera: features.has('dash_camera'),
    bluetoothConnectivity: features.has('bluetooth_connectivity'),
    ...
    collisionAvoidance: features.has('collision_avoidance'),
    blindSpotMonitoring: features.has('blind_spot_monitoring'),
    ...
    inspectionCertificate: features.has('inspection_certificate'),
